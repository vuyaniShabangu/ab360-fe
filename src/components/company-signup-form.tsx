...
export function CompanySignupForm({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    await organization
      ...
      .then((response) => {
        setCookie(Cookies.ORGANIZATION_ID, response.data?.id);
        setCookie(Cookies.ORGANIZATION_NAME, response.data?.name);
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectGroup>
                        ...
                        <SelectItem value="1-10employees">
                          1-10 employees
                        </SelectItem>
                        <SelectItem value="11-50employees">
                          11-50 employees
                        </SelectItem>
                        <SelectItem value="51+employees">
                          51+ employees
                        </SelectItem>
                      </SelectGroup>
                    </SelectContent>
